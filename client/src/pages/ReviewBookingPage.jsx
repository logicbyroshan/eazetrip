...
export default function ReviewBookingPage() {
  ...
  // Directly Launch Razorpay Checkout Gateway
  const handleProceedToPayment = async (e) => {
    ...
    const cleanLeadName = `${title} ${firstName} ${lastName}`.trim();
    const cleanPhoneDigits = contactPhone.toString().replace(/\D/g, '').slice(-10);
    ...
    const bookingPayload = {
      ...
      paymentMethod: 'Razorpay Smart Checkout',
      paymentStatus: 'Paid',
    ...
    setProcessingStatus('Securing order with payment gateway...');
    ...
    try {
      ...
      setProcessingStatus('Awaiting payment authorization in Razorpay...');
          ...
          <div className="sticky-fare-summary-card">
            ...
            >
              {isProcessing ? (
                ...
                <span className="flex-align-center gap-2">
                  <Lock size={18} /> PAY ₹{grandTotal.toLocaleString('en-IN')} NOW
                </span>
              )}
            </button>
